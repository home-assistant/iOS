...
pod 'HAKit', git: 'https://github.com/home-assistant/HAKit.git', branch: 'mtls-rest'
pod 'HAKit/PromiseKit', git: 'https://github.com/home-assistant/HAKit.git', branch: 'mtls-rest'
pod 'HAKit/Mocks', git: 'https://github.com/home-assistant/HAKit.git', branch: 'mtls-rest'
