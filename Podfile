...
pod 'HAKit', git: 'https://github.com/home-assistant/HAKit.git', tag: '0.4.6'
pod 'HAKit/PromiseKit', git: 'https://github.com/home-assistant/HAKit.git', tag: '0.4.6'
pod 'HAKit/Mocks', git: 'https://github.com/home-assistant/HAKit.git', tag: '0.4.6'
