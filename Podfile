...
pod 'HAKit', git: 'https://github.com/bgoncal/HAKit.git', branch: 'mtls'
pod 'HAKit/PromiseKit', git: 'https://github.com/bgoncal/HAKit.git', branch: 'mtls'
pod 'HAKit/Mocks', git: 'https://github.com/bgoncal/HAKit.git', branch: 'mtls'
