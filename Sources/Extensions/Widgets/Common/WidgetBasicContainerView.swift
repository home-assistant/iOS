...
struct WidgetBasicContainerView_Previews: PreviewProvider {
	...
	static var systemSmallConfigurations: SnapshottablePreviewConfigurations<WidgetBasicContainerViewPreviewData> = .init(
	...
	static var systemMediumConfigurations: SnapshottablePreviewConfigurations<WidgetBasicContainerViewPreviewData> = .init(
	...
	static var systemLargeConfigurations: SnapshottablePreviewConfigurations<WidgetBasicContainerViewPreviewData> = .init(
	...
	private static func configurations(for familySize: WidgetFamily) -> [SnapshottablePreviewConfigurations<WidgetBasicContainerViewPreviewData>.Configuration<WidgetBasicContainerViewPreviewData>] {
	...
	private static func models(count: Int, withSubtitle: Bool, withIconBackgroundColor: Bool) -> [WidgetBasicViewModel] {
