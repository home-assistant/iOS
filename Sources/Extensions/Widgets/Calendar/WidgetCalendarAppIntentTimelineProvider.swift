...
struct WidgetCalendarAppIntentTimelineProvider: AppIntentTimelineProvider {
    ...
    func timeline(for configuration: Intent, in context: Context) async -> Timeline<Entry> {
        ...
        let (events, calendarCount) = await fetch(for: configuration, at: now, calendar: calendar)
    ...
    private func fetch(
        ...
        at now: Date,
        calendar: Calendar
    ) async -> (events: [WidgetCalendarEvent], calendarCount: Int) {
