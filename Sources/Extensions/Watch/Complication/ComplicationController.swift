...
class ComplicationController: NSObject, CLKComplicationDataSource {
    ...
    private func complicationModel(for complication: CLKComplication) -> WatchComplication? {
        ...
        if complication.identifier != CLKDefaultComplicationIdentifier {
            ...
            model = Current.realm(objectTypes: [WatchComplication.self]).object(ofType: WatchComplication.self, forPrimaryKey: complication.identifier)
        } else {
            ...
            model = Current.realm(objectTypes: [WatchComplication.self]).object(ofType: WatchComplication.self, forPrimaryKey: matchedFamily.rawValue)
        }
