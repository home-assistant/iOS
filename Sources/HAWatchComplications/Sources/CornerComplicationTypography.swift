...
public enum CornerComplicationTypography {
    ...
    /// number ClockKit drew for a Graphic Corner "Gauge Text" outer text, sized like the system's own
    /// corner gauge complications (UV Index, Battery). The curved variant is typeset by the system and
