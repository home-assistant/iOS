...
public final class ForceCloseWarningManager {
    public static let notificationIdentifier = "force-close-warning"

    private let addRequest: (UNNotificationRequest) -> Void

    public init(addRequest: @escaping (UNNotificationRequest) -> Void = { Current.userNotificationCenter.add($0) }) {
    ...
    public func postImmediateWarning() {
    ...
    public static func readBackgroundLocationEnabled() -> Bool {
        Current.location.permissionStatus() == .authorizedAlways
    }

    public static func makeContent(title: String, body: String) -> UNMutableNotificationContent {
    ...
    public static func makeImmediateRequest(content: UNNotificationContent) -> UNNotificationRequest {
