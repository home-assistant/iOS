...
public enum L10n {
  ...
  public enum SettingsSensors {
    ...
    public enum Health {
      /// Apple Health sensors are turned off until you pick the ones you want. Health data is read only during normal sensor updates.
      ...
      public enum Sensors {
        ...
        /// Only the sensors turned on below are read and sent to Home Assistant. Request access again after turning more of them on, so Apple Health can grant permission for the new ones.
