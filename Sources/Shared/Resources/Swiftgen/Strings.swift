...
public enum L10n {
  ...
  public enum AppMigration {
    ...
    public enum Completed {
      ...
      /// The new app now has %d of your Home Assistant connections, and this app has stopped sending anything to your home.
    ...
    public enum Import {
      public enum Completed {
        /// Your servers are set up, but your widgets, watch and CarPlay configuration could not be restored. You can set them up again in Settings.
        ...
        /// %1$d Home Assistant connection(s) and %2$d configured item(s) are ready to use.
    ...
    public enum Intro {
      ...
      public enum Included {
        ...
        /// %d Home Assistant connection(s), still signed in
    ...
    public enum Step {
      ...
      public enum Export {
        ...
        /// Collecting your Home Assistant connections
      ...
      public enum Import {
        ...
        /// Setting up your Home Assistant connections
