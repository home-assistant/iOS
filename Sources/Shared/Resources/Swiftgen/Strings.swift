...
public enum L10n {
  ...
  public enum Announcement {
    public enum DropSupport {
      ...
      ///  This decision is driven by the need to leverage the latest advancements in iOS development, ensuring a more robust and secure experience for all our users. 
      ///  This will also increase the speed to bring new features to life and stability of the app. 
      /// 
      ///  You can still use Home Assistant on your browser on iOS 12, 13 and 14
