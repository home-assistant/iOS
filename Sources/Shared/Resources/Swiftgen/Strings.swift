...
public enum L10n {
  ...
  public enum SettingsSensors {
    ...
    public enum Health {
      /// Apple Health sensors have their own screen because there are so many of them. They all start switched off. Once turned on, Apple Health data is read during sensor updates and whenever Apple Health records something new, even if the app is closed.
