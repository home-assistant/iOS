    ...
    static func homeState(_ entity: HAEntity) -> HomeEntityState {
        ...
        return HomeEntityState(
            ...
            attributes: HomeEntityAttributes(
                ...
                brightness: (attributes["brightness"] as? NSNumber)?.intValue,
                currentTemperature: (attributes["current_temperature"] as? NSNumber)?.doubleValue,
                targetTemperature: (attributes["temperature"] as? NSNumber)?.doubleValue,
