...
enum AccessibilityIdentifier: String {
    ...
    case onboardingPrivacyLocationExactOption = "onboarding.privacy.location.option.exact"
    case onboardingPrivacyLocationZoneOnlyOption = "onboarding.privacy.location.option.zoneOnly"
    case onboardingPrivacyLocationNeverOption = "onboarding.privacy.location.option.never"
    case onboardingPrivacySensorsAllOption = "onboarding.privacy.sensors.option.all"
    case onboardingPrivacySensorsNoneOption = "onboarding.privacy.sensors.option.none"
    case onboardingPrivacyNext = "onboarding.privacy.next"
