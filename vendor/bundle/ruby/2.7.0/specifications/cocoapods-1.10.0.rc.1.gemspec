# -*- encoding: utf-8 -*-
# stub: cocoapods 1.10.0.rc.1 ruby lib

Gem::Specification.new do |s|
  s.name = "cocoapods".freeze
  s.version = "1.10.0.rc.1"
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.10.0.rc.1"])
    ...
    s.add_runtime_dependency(%q<xcodeproj>.freeze, [">= 1.17.0", "< 2.0"])
    ...
    s.add_dependency(%q<cocoapods-core>.freeze, ["= 1.10.0.rc.1"])
    ...
    s.add_dependency(%q<xcodeproj>.freeze, [">= 1.17.0", "< 2.0"])
