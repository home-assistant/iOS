...
Home Assistant uses Bundler, Homebrew, and SPM to manage build dependencies. You'll need Xcode 27.0 (or later), currently a beta, which you can download from [Apple Developer Downloads](https://developer.apple.com/download/). You can get the app running using the following commands:
