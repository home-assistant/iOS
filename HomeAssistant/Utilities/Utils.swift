...
func setDefaults() {
    // TO-DO Crashlytics.sharedInstance().setObjectValue(prefs.string(forKey: "lastInstalledVersion"),
//                                                forKey: "lastInstalledVersion")
    // TO-DO Crashlytics.sharedInstance().setObjectValue(prefs.integer(forKey: "lastInstalledBundleVersion"),
//                                                forKey: "lastInstalledBundleVersion")
    // TO-DO Crashlytics.sharedInstance().setObjectValue(prefs.string(forKey: "lastInstalledShortVersion"),
