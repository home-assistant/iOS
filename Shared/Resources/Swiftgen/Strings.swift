...
internal enum L10n {
  ...
  internal enum LocationChangeNotification {
    ...
    internal enum Live {
      /// Location updated via live update
      internal static let body = L10n.tr("Localizable", "location_change_notification.live.body")
    }
  ...
  internal enum SettingsDetails {
    ...
    internal enum Privacy {
      ...
      internal enum CrashReporting {
        ...
        internal static let description = L10n.tr("Localizable", "settings_details.privacy.crash_reporting.description")
