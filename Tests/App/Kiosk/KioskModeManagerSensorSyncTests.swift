...
final class KioskModeManagerSensorSyncTests: XCTestCase {
    ...
    private let kioskSensorIds = [WebhookSensorId.kioskBrightness, .kioskVolume]
    ...
    override func tearDown() {
        ...
        if let previousDisabledSensors {
            Current.settingsStore.prefs.set(previousDisabledSensors, forKey: "disabledSensors")
        } else {
            Current.settingsStore.prefs.removeObject(forKey: "disabledSensors")
        }
        super.tearDown()
